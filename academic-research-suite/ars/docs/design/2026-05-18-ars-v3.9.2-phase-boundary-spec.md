...
- `devils_advocate_agent` runs at **Phases 1, 3, 5 + Socratic Layer 2, 4** (per `deep-research/WORKFLOW.md` agent table)
...
- **0.2 (NEW)** Audit each of the 38 unique agent .md files to classify into **4 buckets** (revised per v3 review opus HIGH-1):
  ...
  **Output table columns** (per opus HIGH-1):
  ...
  |---|---|---|---|---|---|
  | bibliography_agent | A | Phase 2 | hard-fence | (none specific to v3.9.2) | deep-research/WORKFLOW.md row 3 |
  | devils_advocate_agent | B | Phase 1, 3, 5, Socratic L2/L4 | none-unmitigated | scope inflation across invocations; awaits v3.10 envelope | deep-research/WORKFLOW.md row 8 |
  | socratic_mentor_agent | C | Socratic Layers 1-5 (phase-orthogonal) | not-applicable | latent: direct-conclusion inflation (different class from #133, not covered) | deep-research/WORKFLOW.md row 10 |
