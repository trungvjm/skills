...
1. `academic-pipeline/WORKFLOW.md` frontmatter `version` and footer Skill Info: `3.6.4 → 3.6.5`.
2. `deep-research/WORKFLOW.md` frontmatter `version` and footer Skill Info: `2.9.x → 2.9.(x+1)` patch bump.
3. `academic-paper/WORKFLOW.md` frontmatter `version` and footer Skill Info: `3.1.x → 3.1.(x+1)` patch bump.
...
- `deep-research/WORKFLOW.md` 2.9.x → 2.9.(x+1) — bibliography_agent corpus-first flow.
- `academic-paper/WORKFLOW.md` 3.1.x → 3.1.(x+1) — literature_strategist_agent corpus-first flow.
