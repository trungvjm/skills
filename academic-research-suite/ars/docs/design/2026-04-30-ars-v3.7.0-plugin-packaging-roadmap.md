...
**Files:**
- Verify: `deep-research/WORKFLOW.md` `academic-paper/WORKFLOW.md` `academic-paper-reviewer/WORKFLOW.md` `academic-pipeline/WORKFLOW.md`

- [ ] **Step 1: 確認 4 個 skill 都有合法 frontmatter**

Run: `for f in deep-research/WORKFLOW.md academic-paper/WORKFLOW.md academic-paper-reviewer/WORKFLOW.md academic-pipeline/WORKFLOW.md; do head -10 "$f"; echo "---"; done`
